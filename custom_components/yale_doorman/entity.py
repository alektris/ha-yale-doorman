"""Base entity for the Yale Doorman L3S integration."""
...
class YaleDoormanEntity(Entity):
    """Base class for Yale Doorman entities."""
    ...
    def __init__(self, data: YaleDoormanData) -> None:
        ...
        self._attr_device_info = DeviceInfo(
            name=data.title,
            manufacturer=lock_info.manufacturer or "Yale",
    ...
    def _async_update_state(
        ...
        self._attr_available = bool(
            not new_state.auth or new_state.auth.successful
        )
    ...
    def _async_device_unavailable(
        ...
        """Handle device no longer being seen by the bluetooth stack."""
        self._attr_available = False
        self.async_write_ha_state()
    ...
    async def async_added_to_hass(self) -> None:
        ...
        self.async_on_remove(
            self._device.register_callback(self._async_state_changed)
        )
